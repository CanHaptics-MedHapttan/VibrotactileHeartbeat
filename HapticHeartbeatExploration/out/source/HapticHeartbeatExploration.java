/* autogenerated by Processing revision 1293 on 2024-03-22 */
...
public void setup(){
  ...
  try{
    ...
    String filePath = "C:\\Users\\naomi\\Documents\\GIT\\ETS\\CanHaptics\\Project\\HapticHeartbeatExploration\\audio\\gong.wav";
...
private int[] getWavAmplitudes(File file) throws UnsupportedAudioFileException , IOException {
  ...
  try (AudioInputStream input = AudioSystem.getAudioInputStream(file)) {
    ...
    //Encoding
    Encoding encoding = AudioFormat.Encoding.PCM_UNSIGNED;//baseFormat.getEncoding();//AudioFormat.Encoding.PCM_UNSIGNED;
    ...
    try (AudioInputStream pcmDecodedInput = AudioSystem.getAudioInputStream(decodedFormat, input)) {
      ...
      println("BBB");
        ...
        println("end try");
      System.out.println(Arrays.toString(finalAmplitudes));
